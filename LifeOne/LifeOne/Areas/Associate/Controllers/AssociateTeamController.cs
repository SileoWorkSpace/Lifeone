...
namespace LifeOne.Areas.Associate.Controllers
{
    ...
    public class AssociateTeamController : Controller
    {
        ...
        public ActionResult MyDirect(int? Page, string FK_MemId, AssociateTeam team)
        {
            ...
            team.Directs = AssociateTeamService.GetDirectList(Fk_MemId, team.SearchLoginId);
        ...
        public ActionResult MyDownline(int? Page, string FK_MemId, AssociateTeam team,string Leg)
        {
            int TotalRecords = 0;
            int PageSize = SessionManager.Size;
            int Fk_MemId = Convert.ToInt32(SessionManager.AssociateFk_MemId);
            ...
            team.Downlines = AssociateTeamService.GetDownlineList(Fk_MemId, team.SearchLoginId, Page, PageSize,Leg);
