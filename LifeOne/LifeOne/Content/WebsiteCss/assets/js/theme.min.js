  ...
  APP.colorModes = {
    ...
    colorModes: function () {
      ...
      const e = localStorage.getItem("theme"),
          t = () => e ? e : window.matchMedia("(prefers-color-scheme: dark)").matches ? "light" : "light",
            n = function (e) {
                e === "auto" && window.matchMedia("(prefers-color-scheme: dark)").matches ? document.documentElement.setAttribute("data-bs-theme", "light") : (e === "auto" && (e = "light"), document.documentElement.setAttribute("data-bs-theme", e));
      };
