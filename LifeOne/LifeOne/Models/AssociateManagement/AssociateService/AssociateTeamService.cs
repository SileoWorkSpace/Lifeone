...
namespace LifeOne.Models.AssociateManagement.AssociateService
{
    public class AssociateTeamService
    {
        ...
        {
            List<DirectAPI> obj = DALAssociateTeam.GetDirectList(Fk_MemId, SearchLoginId);
            return obj;
        }
        ...
        {
            List<DownlineAPI> obj = DALAssociateTeam.GetDownlineList(Fk_MemId, SearchLoginId, Page, PageSize, Leg);
            return obj;
        }
