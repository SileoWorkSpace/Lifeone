                    ...
                    for (var RootLevel0 = 0; RootLevel0 < data.length; RootLevel0++) {
                        ...
                        if (data[RootLevel0].Level == "1") {
                            ...
                            Root += "<span class='tf-nc'><span class='id-icon'><img src='" + data[RootLevel0].ActiveInActiveIcon + "' alt='' onclick='BindRoot(\"" + data[RootLevel0].LoginId + "\");'>" +
                                ...
                                "</h5><h5>Package Name : <span>" + data[RootLevel0].PackageName + "</span></h5><div class='busin-id'><h4></h4><span></span></div><table cellpadding='0' cellspacing='0'>" +
                                ...
                                "<tr><td>PV</td><td>" + data[RootLevel0].LeftBP + "</td><td>" + data[RootLevel0].RightBP + "</td><td>" + data[RootLevel0].TotalBusiness + "</td></tr>" +
                                "</table></div></div></a>" +
                                "</span></span> ";
        ...
        success: function (data) {
            ...
            if (data != null && data.length > 0) {
                for (var RootLeftRight1 = 0; RootLeftRight1 < data.length; RootLeftRight1++) {
                    ...
                    var totalbv = data[RootLeftRight1].LeftBP + data[RootLeftRight1].RightBP;
                    if (data[RootLeftRight1].Leg == 'L' && data[RootLeftRight1].MemId != "-1") {
                        ...
                        RootLeft += "<span class='tf-nc'><span class='id-icon'> <img src='" + data[RootLeftRight1].ActiveInActiveIcon + "' alt='' onclick='BindRoot(\"" + data[RootLeftRight1].LoginId + "\");'></span> <span class='id' onclick='BindRoot(\"" + data[RootLeftRight1].LoginId + "\");'>" + data[RootLeftRight1].LoginId + "</span>" +
                            ...
                            "<h4>" + data[RootLeftRight1].MemberName + "</h4><h5>Sponsor Id : <span>" + data[RootLeftRight1].SponsorLoginId + "</span></h5><h5>Joining On : <span>" + data[RootLeftRight1].JoiningDate + "</span></h5><h5>Package Name : <span>" + data[RootLeftRight1].PackageName + "</span></h5>" +
                            ...
                            "<tr><td>PV</td><td>" + data[RootLeftRight1].LeftBP + "</td><td>" + data[RootLeftRight1].RightBP + "</td><td>" + totalbv + "</td></tr>" +
                            "</table></div></div></a>" +
                            "</span></span>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var RootLeftRightLeft2 = 0; RootLeftRightLeft2 < data.length; RootLeftRightLeft2++) {
                ...
                var totalbv = data[RootLeftRightLeft2].LeftBP + data[RootLeftRightLeft2].RightBP;
                ...
                if (data[RootLeftRightLeft2].Leg == 'L' && data[RootLeftRightLeft2].MemId != "-1") {
                    ...
                    divRootLeftLeft += "<span class='tf-nc'><span class='id-icon'> <img src='" + data[RootLeftRightLeft2].ActiveInActiveIcon + "' alt='' onclick='BindRoot(\"" + data[RootLeftRightLeft2].LoginId + "\");'></span> <span class='id' onclick='BindRoot(\"" + data[RootLeftRightLeft2].LoginId + "\");'>" + data[RootLeftRightLeft2].LoginId + "</span> <span class='id-name'>" +
                        ...
                        "<h4>" + data[RootLeftRightLeft2].MemberName + "</h4><h5>Sponsor Id : <span>" + data[RootLeftRightLeft2].SponsorLoginId + "</span></h5><h5>Joining On : <span>" + data[RootLeftRightLeft2].JoiningDate + "</span></h5><h5>Package Name : <span>" + data[RootLeftRightLeft2].PackageName + "</span></h5>" +
                        "<div class='busin-id'><h4></h4><span></span></div><table cellpadding='0' cellspacing='0'>" +
                        "<tr><td>Type</td><td>Left</td><td>Right</td><td>Total</td></tr>" +
                        ...
                        "<tr><td>PV</td><td>" + data[RootLeftRightLeft2].LeftBP + "</td><td>" + data[RootLeftRightLeft2].RightBP + "</td><td>" + totalbv + "</td></tr>" +
                        "</table></div></div></a>" +
                        "</span></span>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var RootLeftRightLeftLeft3 = 0; RootLeftRightLeftLeft3 < data.length; RootLeftRightLeftLeft3++) {
                ...
                var totalbv = data[RootLeftRightLeftLeft3].LeftBP + data[RootLeftRightLeftLeft3].RightBP;
                if (data[RootLeftRightLeftLeft3].Leg == 'L' && data[RootLeftRightLeftLeft3].MemId != "-1") {
                    ...
                    divRootLeftLeftLeft += "<span class='tf-nc'><span class='id-icon'> <img src='" + data[RootLeftRightLeftLeft3].ActiveInActiveIcon + "' alt='' onclick='BindRoot(\"" + data[RootLeftRightLeftLeft3].LoginId + "\");'></span> <span class='id' onclick='BindRoot(\"" + data[RootLeftRightLeftLeft3].LoginId + "\");'>" + data[RootLeftRightLeftLeft3].LoginId + "</span> <span class='id-name'>" +
                        ...
                        "<h4>" + data[RootLeftRightLeftLeft3].MemberName + "</h4><h5>Sponsor Id : <span>" + data[RootLeftRightLeftLeft3].SponsorLoginId + "</span></h5><h5>Joining On : <span>" + data[RootLeftRightLeftLeft3].JoiningDate + "</span></h5><h5>Package Name : <span>" + data[RootLeftRightLeftLeft3].PackageName + "</span></h5>" +
                        "<div class='busin-id'><h4></h4><span></span></div><table cellpadding='0' cellspacing='0'>" +
                        "<tr><td>Type</td><td>Left</td><td>Right</td><td>Total</td></tr>" +
                        ...
                        "<tr><td>PV</td><td>" + data[RootLeftRightLeftLeft3].LeftBP + "</td><td>" + data[RootLeftRightLeftLeft3].RightBP + "</td><td>" + totalbv + "</td></tr>" +
                        "</table></div></div></a>" +
                        "</span></span>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var RootLeftRight2 = 0; RootLeftRight2 < data.length; RootLeftRight2++) {
                ...
                var totalbv = data[RootLeftRight2].LeftBP + data[RootLeftRight2].RightBP;
                ...
                if (data[RootLeftRight2].Leg == 'L' && data[RootLeftRight2].MemId != "-1") {
                    divRootLeftLeft += "<span class='tf-nc'><span class='id-icon'> <img src='" + data[RootLeftRight2].ActiveInActiveIcon + "' alt='' onclick='BindRoot(\"" + data[RootLeftRight2].LoginId + "\");'></span> <span class='id' onclick='BindRoot(\"" + data[RootLeftRight2].LoginId + "\");'>" + data[RootLeftRight2].LoginId + "</span> <span class='id-name'>" +
                        ...
                        "<h4>" + data[RootLeftRight2].MemberName + "</h4><h5>Sponsor Id : <span>" + data[RootLeftRight2].SponsorLoginId + "</span></h5><h5>Joining On : <span>" + data[RootLeftRight2].JoiningDate + "</span></h5><h5>Package Name : <span>" + data[RootLeftRight2].PackageName + "</span></h5>" +
                        "<div class='busin-id'><h4></h4><span></span></div><table cellpadding='0' cellspacing='0'>" +
                        "<tr><td>Type</td><td>Left</td><td>Right</td><td>Total</td></tr>" +
                        ...
                        "<tr><td>PV</td><td>" + data[RootLeftRight2].LeftBP + "</td><td>" + data[RootLeftRight2].RightBP + "</td><td>" + totalbv + "</td></tr>" +
                        "</table></div></div></a>" +
                        "</span></span>";
