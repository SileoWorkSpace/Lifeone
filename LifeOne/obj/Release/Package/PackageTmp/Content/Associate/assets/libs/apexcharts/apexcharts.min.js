...
!(function (t, e) {
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                t.unfilter(!0),
                                d.isIE() && "radialBar" === h.config.chart.type
                                    ? t
            ...
            return (
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.w;
                            (t.globals.animationEnded = !0), "function" == typeof t.config.chart.events.animationEnd && t.config.chart.events.animationEnd(this.ctx, t);
                        },
                    },
                    {
                        key: "morphSVG",
                        value: function (t, e, i, s, a, n, r) {
                            ...
                            i || (i = t.attr("pathFrom")),
                                ...
                                t
                                    ...
                                    .plot(s)
                                    .afterAll(function () {
                                        d.isNumber(e) ? e === l.globals.series[l.globals.maxValsInArrayIndex].length - 2 && l.globals.shouldAnimate && o.animationCompleted() : l.globals.shouldAnimate && o.animationCompleted(),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e,
                                    ...
                                    P = !!((L && !A.globals.resized) || (z && A.globals.dataChanged && A.globals.shouldAnimate));
                                P ? (e = a) : ((e = r), C.animationCompleted());
                                var E = A.config.stroke.dashArray,
                                    M = 0;
                                M = Array.isArray(E) ? E[s] : A.config.stroke.dashArray;
                                var T = this.drawPath({ d: e, stroke: o, strokeWidth: l, fill: c, fillOpacity: 1, classes: x, strokeLinecap: h, strokeDashArray: M });
                                if ((T.attr("index", s), m && T.attr({ "clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")") }), "none" !== A.config.states.normal.filter.type)) S.getDefaultFilter(T, s);
                                else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledSeries || (A.config.chart.dropShadow.enabledSeries && -1 !== A.config.chart.dropShadow.enabledSeries.indexOf(s)))) {
                                ...
                                y &&
                                    ...
                                    T.attr({ pathTo: r, pathFrom: a });
                                var I = { el: T, j: i, pathFrom: a, pathTo: r, strokeWidth: l };
                                return (
                                    !L || A.globals.resized || A.globals.dataChanged ? (!A.globals.resized && A.globals.dataChanged) || C.showDelayedElements() : C.animatePathsGradually(n({}, I, { speed: f, delay: d })),
                                    A.globals.dataChanged && z && P && C.animatePathsGradually(n({}, I, { speed: p })),
                                    T
                                );
                            },
                        },
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ...
                                    (e = Array.isArray(n)
                                        ...
                                        : i.globals.dom.Paper.plain(n)).attr({ x: s, y: a, "text-anchor": r, "dominant-baseline": "auto", "font-size": o, "font-family": l, "font-weight": h, fill: c, class: (t.cssClass, t.cssClass) }),
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                "function" == typeof i.config.chart.events.dataPointSelection &&
                                    ...
                                    e && this.ctx.fireEvent("dataPointSelection", [e, this.ctx, { selectedDataPoints: i.globals.selectedDataPoints, seriesIndex: a, dataPointIndex: n, w: i }]);
                            },
                        },
                        {
    ...
    var p = {
                            ...
                            if (t.globals.axisCharts) {
                                for (
                                    ...
                                    t.globals.dom.elGraphical.add(n[o]),
                                        !a || t.globals.resized || t.globals.dataChanged || ("scatter" !== t.config.chart.type && "bubble" !== t.config.chart.type && r[o].classList.add("hidden")),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            var s = this.w,
                                ...
                                o = t.label.text;
                            ("category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric) || this.invertAxis || s.globals.isXNumeric || (r = this.getStringX(t.x));
                            var l = t.strokeDashArray;
                            if (!(r < 0 || r > s.globals.gridWidth)) {
                                if (null === t.x2) {
                                    var h = this.graphics.drawLine(r + t.offsetX, 0 + t.offsetY, r + t.offsetX, s.globals.gridHeight + t.offsetY, t.borderColor, l);
                                    e.appendChild(h.node);
                                } else {
                                    var c = (t.x2 - a) / (n / s.globals.gridWidth);
                                    if ((("category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric) || this.invertAxis || s.globals.isXNumeric || (c = this.getStringX(t.x2)), c < r)) {
                                        var d = r;
                                        (r = c), (c = d);
                                    }
                                    if (o) {
                                        var u = this.graphics.drawRect(r + t.offsetX, 0 + t.offsetY, c - r, s.globals.gridHeight + t.offsetY, 0, t.fillColor, t.opacity, 1, t.borderColor, l);
                                        e.appendChild(u.node);
                                    }
                                }
                                var g = "top" === t.label.position ? -3 : s.globals.gridHeight,
                                ...
                                f.attr({ rel: i }), e.appendChild(f.node), this.setOrientations(t, i);
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            var s = t.x,
                                ...
                                E = this.graphics.drawText({ x: s, y: a, text: n, textAnchor: r || "start", fontSize: c || "12px", fontFamily: d || z.config.chart.fontFamily, foreColor: h || z.config.chart.foreColor, cssClass: u });
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                t.color && (r = t.color),
                                -1 === r.indexOf("rgb") ? (h = d.hexToRgba(r, l)) : r.indexOf("rgba") > -1 && (l = "0." + d.getOpacityFromRGBA(r)),
                                "pattern" === o && (s = this.handlePatternFill(s, r, l, h)),
                                "gradient" === o && (a = this.handleGradientFill(a, r, l, this.seriesIndex)),
                                n.fill.image.src.length > 0 && "image" === o
                                    ? t.seriesNumber < n.fill.image.src.length
                                        ? (this.clippedImgArea({ opacity: l, image: n.fill.image.src[t.seriesNumber], patternUnits: t.patternUnits, patternID: "pattern".concat(e.globals.cuid).concat(t.seriesNumber + 1) }),
                                          (i = "url(#pattern".concat(e.globals.cuid).concat(t.seriesNumber + 1, ")")))
                                        : (i = h)
                                    : (i = "gradient" === o ? a : "pattern" === o ? s : h),
                                t.solid && (i = h),
                                i
                            );
                        },
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            var s,
                                ...
                                o = null,
                                l = new f(this.ctx);
                            if ((a.globals.markers.size[e] > 0 && (o = l.group({ class: "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), r.x instanceof Array))
                                for (var h = 0; h < r.x.length; h++) {
                                    var c = i;
                                    1 === i && 0 === h && (c = 0), 1 === i && 1 === h && (c = 1);
                                    var g = "apexcharts-marker";
                                    if (
                                        (("line" !== a.config.chart.type && "area" !== a.config.chart.type) || a.globals.comboCharts || a.config.tooltip.intersect || (g += " no-pointer-events"),
                                        Array.isArray(a.config.markers.size) ? a.globals.markers.size[e] > 0 : a.config.markers.size > 0)
                                    ) {
                                        d.isNumber(r.y[h]) ? (g += " w".concat((Math.random() + 1).toString(36).substring(4))) : (g = "apexcharts-nullpoint");
                                        var p = this.getMarkerConfig(g, e, c);
                                        a.config.series[n].data[i] &&
                                            (a.config.series[n].data[i].fillColor && (p.pointFillColor = a.config.series[n].data[i].fillColor),
                                            a.config.series[n].data[i].strokeColor && (p.pointStrokeColor = a.config.series[n].data[i].strokeColor)),
                                            (s = l.drawMarker(r.x[h], r.y[h], p)).attr("rel", c),
                                            s.attr("j", c),
                                            s.attr("index", e),
                                            s.node.setAttribute("default-marker-size", p.pSize),
                                            new u(this.ctx).setSelectionFilter(s, e, c),
                                            this.addEvents(s),
                                            o && o.add(s);
                                    } else void 0 === a.globals.pointsArray[e] && (a.globals.pointsArray[e] = []), a.globals.pointsArray[e].push([r.x[h], r.y[h]]);
                                }
                            return o;
                        },
                    },
                    {
                        ...
                        value: function (t, e) {
                            var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                                ...
                                n = s.globals.markers.size[e];
                            return (
                                null !== i &&
                                    s.config.markers.discrete.length &&
                                    s.config.markers.discrete.map(function (t) {
                                        t.seriesIndex === e && t.dataPointIndex === i && ((a.pointStrokeColor = t.strokeColor), (a.pointFillColor = t.fillColor), (n = t.size));
                                    }),
                                {
                                    pSize: n,
                                    pRadius: s.config.markers.radius,
                                    pWidth: s.config.markers.strokeWidth,
                                    pointStrokeColor: a.pointStrokeColor,
                                    pointFillColor: a.pointFillColor,
                                    shape: s.config.markers.shape instanceof Array ? s.config.markers.shape[e] : s.config.markers.shape,
                                    class: t,
                                    pointStrokeOpacity: s.config.markers.strokeOpacity,
                                    pointFillOpacity: s.config.markers.fillOpacity,
                                    seriesIndex: e,
                                }
                            );
                        },
                        ...
                        value: function (t, e, i, s, a, n, r) {
                            ...
                            if (o.globals.dataChanged)
                                if (this.dynamicAnim) {
                                    ...
                                    for (var E = 0; E < o.globals.collapsedSeries.length; E++) o.globals.collapsedSeries[E].index === a && ((P = 1), (s = 0));
                ...
                s(t, [
                    {
                        ...
                        value: function (t, e, i, s, a, n, r) {
                            ...
                            return (0 === a || n) && (l = !0), { x: t, y: e, textRects: h, drawnextLabel: l };
                        },
                    },
                    {
                        key: "drawDataLabel",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(n) < 0)) {
                                ...
                                if (
                                    (g && (p = this.dataLabelsCorrection(s, a, o, n, r, d, parseInt(c.style.fontSize))),
                                    e.globals.zoomed || ((s = p.x), (a = p.y)),
                                    p.textRects && (s + p.textRects.width < 10 || s > e.globals.gridWidth + 10) && (o = ""),
                                    p.drawnextLabel)
                                ) {
                                    var x = i.drawText({
                                        width: 100,
                ...
                s(t, [
                    {
                        ...
                        value: function (t, e) {
                            ...
                            for (var r = 0, o = 0; r < t.length; r++, o++) {
                                ...
                                for (var z = s.group({ class: "apexcharts-datalabels" }), P = 0, E = i.globals.dataPoints; P < i.globals.dataPoints; P++, E--) {
                                    ...
                                    var M = null;
                                    this.isHorizontal
                                        ? ((M = this.drawBarPaths({ indexes: { i: r, j: P, realIndex: w, bc: o }, barHeight: S, strokeWidth: A, pathTo: g, pathFrom: p, zeroW: u, x: x, y: b, yDivision: h, elSeries: k })),
                                          (C = this.series[r][P] / this.invertedYRatio))
                                        : ((M = this.drawColumnPaths({ indexes: { i: r, j: P, realIndex: w, bc: o }, x: x, y: b, xDivision: l, pathTo: g, pathFrom: p, barWidth: C, zeroH: c, strokeWidth: A, elSeries: k })),
                            ...
                            return (
                                this.isHorizontal
                                    ...
                                    : ((n = (((s = l.globals.gridWidth / this.visibleItems) / this.seriesLen) * parseInt(this.barOptions.columnWidth)) / 100),
                                      l.globals.isXNumeric && (l.globals.minXDiff && (s = l.globals.minXDiff / this.xRatio), (n = ((s / this.seriesLen) * parseInt(this.barOptions.columnWidth)) / 100)),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = t.x,
                                ...
                                p = c.formatter,
                                x = null,
                                b = d.globals.collapsedSeriesIndices.indexOf(a) > -1;
                            if (c.enabled && !b) {
                                x = g.group({ class: "apexcharts-data-labels" });
                                var m = "";
                                void 0 !== s && (m = p(s, { seriesIndex: a, dataPointIndex: r, w: d })),
                                    0 === s && d.config.chart.stacked && (m = ""),
                                    d.config.chart.stacked &&
                                        this.barOptions.dataLabels.hideOverflowingLabels &&
                                        (this.isHorizontal
                                            ? (((h = this.series[a][r] / this.yRatio[this.yaxisIndex]) > 0 && o.width / 1.6 > h) || (h < 0 && o.width / 1.6 < h)) && (m = "")
                                            : ((l = this.series[a][r] / this.yRatio[this.yaxisIndex]), o.height / 1.6 > l && (m = "")));
                                var v = n({}, c);
                                this.isHorizontal && s < 0 && ("start" === c.textAnchor ? (v.textAnchor = "end") : "end" === c.textAnchor && (v.textAnchor = "start")),
                                    u.plotDataLabelsText({ x: e, y: i, text: m, i: a, j: r, parent: x, dataLabelsConfig: v, alwaysDrawDataLabel: !0, offsetCorrection: !0 });
                            }
                            return x;
                        },
                    },
                        ...
                        value: function (t, e) {
                            ...
                            for (var n = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }), r = 0, o = 0, l = 0, h = 0; l < t.length; l++, h++) {
                                ...
                                for (var M = 0; M < i.globals.dataPoints; M++) {
                                    ...
                                    var T = null;
                                    this.isHorizontal
                                        ? ((T = this.drawBarPaths({ indexes: { i: l, j: M, realIndex: w, bc: h }, barHeight: L, strokeWidth: C, pathTo: c, pathFrom: u, zeroW: b, x: r, y: o, yDivision: p, elSeries: k })),
                                          (z = this.series[l][M] / this.invertedYRatio))
                                        : ((T = this.drawColumnPaths({ indexes: { i: l, j: M, realIndex: w, bc: h }, x: r, y: o, xDivision: g, pathTo: c, pathFrom: u, barWidth: z, zeroH: x, strokeWidth: C, elSeries: k })),
                        ...
                        value: function (t, e) {
                            ...
                            for (var r = s.group({ class: "apexcharts-candlestick-series apexcharts-plot-series" }), o = 0, l = 0; o < t.length; o++, l++) {
                                ...
                                for (var z = s.group({ class: "apexcharts-datalabels" }), P = 0, E = i.globals.dataPoints; P < i.globals.dataPoints; P++, E--) {
                                    ...
                                    var X = a.fillPath({ seriesNumber: v, color: M, value: t[o][P] }),
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, s, a, n) {
                            ...
                            r.animateRect(t, { x: e + s / 2, y: i + a / 2, width: 0, height: 0 }, { x: e, y: i, width: s, height: a }, n, function () {
                                r.animationCompleted();
                            });
                        },
                    },
                    {
        ...
        I = (function () {
            function t(i) {
                ...
                (this.lineColorArr = void 0 !== s.globals.stroke.colors ? s.globals.stroke.colors : s.globals.colors),
                    ...
                    (this.fullAngle = 360),
                    (s.globals.radialSize = this.defaultSize / 2.05 - s.config.stroke.width - s.config.chart.dropShadow.blur),
                    void 0 !== s.config.plotOptions.pie.size && (s.globals.radialSize = s.config.plotOptions.pie.size),
                    (this.donutSize = (s.globals.radialSize * parseInt(s.config.plotOptions.pie.donut.size)) / 100),
                    (this.sliceLabels = []),
                ...
                s(t, [
                    {
                        ...
                        value: function (t) {
                            ...
                            for (var a = 0, n = 0; n < t.length; n++) a += d.negToZero(t[n]);
                            var r = [],
                                o = i.group();
                            0 === a && (a = 1e-5);
                            ...
                            if ("donut" === e.config.chart.type) {
                                ...
                                w.attr({ cx: this.centerX, cy: this.centerY, fill: e.config.plotOptions.pie.donut.background }), o.add(w);
                            }
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            for (var g = 0; g < t.length; g++) {
                                var p = a.group({ class: "apexcharts-series apexcharts-pie-series", seriesName: d.escapeString(i.globals.seriesNames[g]), rel: g + 1, "data:realIndex": g });
                                r.add(p), (l = c), (h = (o = h) + t[g]), (c = l + this.prevSectorAngleArr[g]);
                                var x = h - o,
                                    b = n.fillPath({ seriesNumber: g, size: i.globals.radialSize, value: e[g] }),
                                ...
                                if ((v.attr({ index: 0, j: g }), i.config.chart.dropShadow.enabled)) {
                                ...
                                "pie" === i.config.chart.type
                                    ? (w = d.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2))
                                    : "donut" === i.config.chart.type && (w = d.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2)),
                                    p.add(v);
                                var k = 0;
                                if (
                                    ...
                                    this.dynamicAnim && i.globals.dataChanged
                                        ...
                                        : this.animatePaths(v, { size: i.globals.radialSize, endAngle: h, startAngle: o, i: g, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: k }),
                                    ...
                                    if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[g]) {
                                        ...
                                        var P = i.globals.dataLabels.style.colors[g],
                                            E = a.drawText({ x: A, y: C, text: L, textAnchor: "middle", fontSize: i.config.dataLabels.style.fontSize, fontFamily: i.config.dataLabels.style.fontFamily, foreColor: P });
                                        ...
                                        E.node.classList.add("apexcharts-pie-label"),
                                            i.config.chart.animations.animate && !1 === i.globals.resized && (E.node.classList.add("apexcharts-pie-label-delay"), (E.node.style.animationDelay = i.config.chart.animations.speed / 940 + "s")),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, s, a, n) {
                            ...
                            var d = s,
                                u = i,
                                f = e - i;
                            l.globals.dataChanged && n.shouldSetPrevPaths && ((r = o.getPiePath({ me: o, startAngle: u, angle: a, size: c })), t.attr({ d: r })),
                                0 !== n.dur
                                    ? t
                                          .animate(n.dur, l.globals.easing, n.animBeginArr[n.i])
                                          .afterAll(function () {
                                              ("pie" !== l.config.chart.type && "donut" !== l.config.chart.type) || this.animate(300).attr({ "stroke-width": l.config.stroke.width }),
                                                  n.i === l.config.series.length - 1 && h.animationCompleted();
                                          })
                                          .during(function (l) {
                                              (d = f + (s - f) * l),
                                    ...
                                    : ((r = o.getPiePath({ me: o, startAngle: u, angle: s, size: c })), n.isTrack || (l.globals.animationEnded = !0), t.node.setAttribute("data:pathOrig", r), t.attr({ d: r }));
                        },
                    },
                    {
                        key: "pieClicked",
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                t.forEach(function (t, r) {
                                    ...
                                    t.forEach(function (t, i) {
                                        var s = new C(e.ctx).getMarkerConfig("apexcharts-marker", r, i),
                ...
                s(i, [
                        ...
                        value: function (t) {
                            ...
                            for (var o = 0; o < t.series.length; o++) {
                                ...
                                l.add(p),
                                    ...
                                    this.animatePaths(p, { centerX: t.centerX, centerY: t.centerY, endAngle: g, startAngle: d, size: t.size, i: o, totalItems: 2, animBeginArr: 0, dur: 0, isTrack: !0, easing: e.globals.easing });
                            }
                            return s;
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var x = null;
                            this.radialDataLabels.show && (x = this.renderInnerDataLabels(this.radialDataLabels, { hollowSize: l, centerX: t.centerX, centerY: t.centerY, opacity: p })),
                            ...
                            for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                                var v = i.group({ class: "apexcharts-series apexcharts-radial-series", seriesName: d.escapeString(e.globals.seriesNames[m]) });
                                n.add(v), v.attr({ rel: m + 1, "data:realIndex": m }), this.ctx.series.addCollapsedClassToSeries(v, m), (t.size = t.size - r - this.margin);
                                var y = s.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                                    w = this.startAngle,
                                    k = void 0,
                                    A = Math.abs(e.config.plotOptions.radialBar.endAngle - e.config.plotOptions.radialBar.startAngle),
                                    C = d.negToZero(t.series[m] > 100 ? 100 : t.series[m]) / 100,
                                    L = Math.round(A * C) + this.startAngle,
                                    z = void 0;
                                e.globals.dataChanged && ((k = this.startAngle), (z = Math.round((A * d.negToZero(e.globals.previousPaths[m])) / 100) + k)),
                                ...
                                var P = L - w,
                                    ...
                                    M = i.drawPath({ d: "", stroke: y, strokeWidth: r, fill: "none", fillOpacity: e.config.fill.opacity, classes: "apexcharts-radialbar-area apexcharts-radialbar-slice-" + m, strokeDashArray: E });
                                if ((f.setAttrs(M.node, { "data:angle": P, "data:value": t.series[m] }), e.config.chart.dropShadow.enabled)) {
                                ...
                                !this.initialAnim ||
                                    ...
                                    ((X = ((L - w) / 360) * e.config.chart.animations.speed), (this.animDur = X / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                                    e.globals.dataChanged && ((X = ((L - w) / 360) * e.config.chart.animations.dynamicAnimation.speed), (this.animDur = X / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                                    this.animatePaths(M, {
                                        centerX: t.centerX,
                                        centerY: t.centerY,
                                        endAngle: L,
                        ...
                        value: function (t, e) {
                            ...
                            for (var n = s.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), r = 0, o = 0; r < t.length; r++, o++) {
                                ...
                                for (var z = s.group({ class: "apexcharts-datalabels" }), P = 0, E = i.globals.dataPoints; P < i.globals.dataPoints; P++, E--) {
                                    ...
                                    var M = null;
                                    this.isHorizontal
                                        ? (C = (M = this.drawRangeBarPaths({ indexes: { i: r, j: P, realIndex: y, bc: o }, barHeight: A, strokeWidth: k, pathTo: g, pathFrom: p, zeroW: u, x: x, y: b, yDivision: h, elSeries: w })).barWidth)
                                        : (A = (M = this.drawRangeColumnPaths({ indexes: { i: r, j: P, realIndex: y, bc: o }, x: x, y: b, xDivision: l, pathTo: g, pathFrom: p, barWidth: C, zeroH: c, strokeWidth: k, elSeries: w }))
                                              .barHeight),
                                        (g = M.pathTo),
                                        (p = M.pathFrom),
                                        (b = M.y),
                ...
                s(t, [
                    {
                        ...
                        value: function (t, e, i) {
                            var s = this.w;
                            if ("datetime" === s.config.xaxis.type && void 0 === s.config.xaxis.labels.formatter && void 0 === s.config.tooltip.x.formatter) return new m(this.ctx).formatDate(new Date(e), s.config.tooltip.x.format, !0, !0);
                            return t(e, i);
                        },
                    },
                    {
                                ...
                                t.config.yaxis.forEach(function (e, i) {
                                    void 0 !== e.labels.formatter
                                        ...
                                        : (t.globals.yLabelFormatters[i] = function (s) {
                                              return t.globals.xyCharts && d.isNumber(s)
                                                  ? 0 !== t.globals.yValueDecimal
                                                      ? s.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : t.globals.yValueDecimal)
                ...
                s(t, [
                    {
                        ...
                        value: function (t, e, i, s) {
                            var a,
                                ...
                                c = !1,
                                d = o;
                            (a = new D(this.ctx).xLabelFormat(l, o, d)), void 0 !== h && (a = h(o, t[s], s));
                            var u, g;
                            return (
                                e.length > 0
                                    ? ((u = e[s].unit),
                                      ...
                                      (i = e[s].position),
                                      (a = e[s].value))
                                    : "datetime" === r.config.xaxis.type && void 0 === h && (a = ""),
                                void 0 === a && (a = ""),
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            this.setGridXPosForDualYAxis(n, s), new O(this.ctx).setYAxisXPosition(s, n);
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            switch (e.config.legend.position) {
                                case "bottom":
                                    ...
                                    break;
                                case "top":
                                    (i.gridHeight = i.svgHeight - t.height - 35), (i.gridWidth = i.gridHeight), (i.translateY = t.height + a + 10), (i.translateX = n + (i.svgWidth - i.gridWidth) / 2);
                                    break;
                                case "left":
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (e.globals.timelineLabels.length > 0) {
                                ...
                                var o = r;
                                r = new D(this.ctx).xLabelFormat(n, r, o);
                                var l = new f(this.ctx),
                                    h = l.getTextRects(r, e.config.xaxis.labels.style.fontSize);
                                (t = { width: h.width, height: h.height }).width * i.length > e.globals.svgWidth - a - this.yAxisWidth && 0 !== e.config.xaxis.labels.rotate
                                    ? e.globals.isBarHorizontal ||
                ...
                s(t, [
                        ...
                        value: function () {
                            ...
                            for (var n = t.globals.legendFormatter, r = t.config.legend.inverseOrder, o = r ? i.length - 1 : 0; r ? o >= 0 : o <= i.length - 1; r ? o-- : o++) {
                                ...
                                (A.background = s[o]),
                                    ...
                                    f.setAttrs(g, { rel: o + 1, "data:collapsed": h || c }),
                                ...
                                L || (L = t.config.chart.foreColor),
                                    ...
                                    f.setAttrs(C, { rel: o + 1, "data:collapsed": h || c }),
                                    S.appendChild(g),
                                    S.appendChild(C);
                                var z = new y(this.ctx);
                                if (!t.config.legend.showForZeroSeries)
                                    0 === z.getSeriesTotalByIndex(o) &&
                                        z.seriesHaveSameValues(o) &&
                                        !z.isSeriesNull(o) &&
                                ...
                                t.config.legend.showForNullSeries ||
                                    (z.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && S.classList.add("apexcharts-hidden-null-series")),
                                    ...
                                    f.setAttrs(S, { rel: o + 1, "data:collapsed": h || c }),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if ("heatmap" !== e.config.chart.type) !t.target.classList.contains("inactive-legend") && i && new W(this.ctx).toggleSeriesOnHover(t, t.target);
                            else if (i) {
                                var s = parseInt(t.target.getAttribute("rel")) - 1;
                                this.ctx.fireEvent("legendHover", [this.ctx, s, this.w]), new W(this.ctx).highlightRangeInSeries(t, t.target);
                            }
                        },
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            ...
                            for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                                ...
                                var V = T,
                                    ...
                                    j = E,
                                    U = 0;
                                if (((j = this.determineFirstPrevY({ i: v, series: t, yRatio: c[this.yaxisIndex], zeroY: E, prevY: j, prevSeriesY: b, lineYPosition: U }).prevY), L.push(j), (G = j), null === t[v][0])) {
                                ...
                                for (var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, J = 0; J < $; J++) {
                                    ...
                                    s.config.chart.stacked
                                        ? ((U = v > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? b[v - 1][J + 1] : E),
                                          (X =
                                        ...
                                        : (X =
                                              void 0 === t[v][J + 1] || null === t[v][J + 1]
                                                  ...
                                                  : E - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)),
                                        P.push(T),
                                        L.push(X);
                                    var tt = this.createPaths({ series: t, i: v, j: J, x: T, y: X, xDivision: k, pX: V, pY: G, areaBottomY: M, linePath: I, areaPath: Y, linePaths: D, areaPaths: N, seriesIndex: i });
                                ...
                                var rt = { i: v, realIndex: A, animationDelay: v, initialSpeed: s.config.chart.animations.speed, dataChangeSpeed: s.config.chart.animations.dynamicAnimation.speed, className: "apexcharts-".concat(o) };
                                if ("area" === o)
                ...
                s(t, [
                    {
                        ...
                        value: function (t, e, i) {
                            ...
                            var v = t;
                            (o = []).push(v);
                            for (var y = Math.abs(e - t) / a, w = 0; w <= a; w++) (v += y), o.push(v);
                            ...
                            return (
                                e.forEach(function (t, r) {
                                    ...
                                    var h,
                                        ...
                                        g = s.globals.stackedSeriesTotals;
                                        ...
                                        n
                                            ? ((f = g[o]),
                                              ...
                                              g.forEach(function (t, e) {
                                                  a[e] <= i.xaxis.max && a[e] >= i.xaxis.min && (t > c && null !== t && (c = t), r[e] < h && null !== r[e] && (h = r[e]));
                                              }))
                                            : ((h = c = f),
                                              r.forEach(function (t, e) {
                                            ...
                                            e.length > 1 ? ((e[l].min = void 0 === t.min ? h : t.min), (e[l].max = void 0 === t.max ? c : t.max)) : ((e[0].min = void 0 === t.min ? h : t.min), (e[0].max = void 0 === t.max ? c : t.max));
                                    });
                                }),
                                e
                            );
        ...
        j = (function () {
            function t(i) {
                e(this, t), (this.ctx = i), (this.w = i.w), (this.scales = new _(i));
            }
            return (
                s(t, [
                    {
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            e ? (i.globals.invertedTimelineLabels = a.slice()) : (i.globals.timelineLabels = a.slice()), new H(this.ctx).plotCoords();
                        },
                    },
                    {
                ...
                s(t, [
                            ...
                            if (a.comboCharts) {
                                ...
                                switch (s.chart.type) {
                                    ...
                                    case "area":
                                        ...
                                        break;
                                    case "bar":
                                        if (s.chart.stacked) x = new E(this.ctx, e).draw(a.series);
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), f.setAttrs(t.dom.Paper.node, { width: t.svgWidth, height: t.svgHeight });
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.w,
                                e = t.globals,
                                i = 0;
                            ("top" !== t.config.legend.position && "bottom" !== t.config.legend.position) || (i = new B(this.ctx).getLegendBBox().clwh + 10);
                            var s = t.globals.dom.baseEl.querySelector(".apexcharts-radialbar"),
                                a = 2 * t.globals.radialSize;
                            s && -90 !== t.config.plotOptions.radialBar.startAngle && (a = d.getBoundingClientRect(s).height);
                            var n = Math.max(a, 2 * t.globals.radialSize) + e.translateY + i + 20;
                            e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", n),
                                (e.dom.elWrap.style.height = n + "px"),
                                f.setAttrs(e.dom.Paper.node, { height: n }),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            var s = [],
                                ...
                                r = new W(this.ctx).getActiveConfigSeriesIndex();
                            if ("array" === t) {
                                    ...
                                    (e.config.chart.events.selection = function (t, s) {
                                        i.forEach(function (t) {
                                            var i = ApexCharts.getChartByID(t),
                                                a = d.clone(e.config.yaxis);
                                            e.config.chart.brush.autoScaleYaxis && (a = new _(i).autoScaleY(i, a, s));
                                            i._updateOptions({ xaxis: { min: s.xaxis.min, max: s.xaxis.max }, yaxis: a }, !1, !1, !1, !1);
                                        });
                                    });
                            }
                        },
              ...
              J._immediateFn(function () {
                  ...
                  if (null !== i) {
                      ...
                      try {
                          ...
                          return void tt(e.promise, t);
                      }
                      K(e.promise, s);
                  } else (1 === t._state ? K : tt)(e.promise, t._value);
              }))
            : t._deferreds.push(e);
    }
    function K(t, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                var i = e.then;
                if (e instanceof J) return (t._state = 3), (t._value = e), void et(t);
    ...
    function tt(t, e) {
        (t._state = 2), (t._value = e), et(t);
    }
    function et(t) {
        2 === t._state &&
            0 === t._deferreds.length &&
            J._immediateFn(function () {
                t._handled || J._unhandledRejectionFn(t._value);
            });
        for (var e = 0, i = t._deferreds.length; e < i; e++) Q(t, t._deferreds[e]);
        t._deferreds = null;
    }
    function it(t, e, i) {
    ...
    (J.prototype.catch = function (t) {
        ...
        (J.resolve = function (t) {
            return t && "object" == typeof t && t.constructor === J
                ? t
                : new J(function (e) {
                      e(t);
                  });
                            ...
                            if (t.globals.isBarHorizontal) {
                                if (((r = o), t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show))
                                    for (var h, c = t.globals.padHorizontal, d = t.globals.gridHeight, u = 0; u < r + 1 && ((h = c = c + t.globals.gridWidth / r + 0.3), u !== r - 1); u++) {
                                        ...
                                        new G(this.ctx).drawXaxisTicks(c, s);
                                    }
                                ...
                                if (((r = this.xaxisLabels.length), t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show)) {
                                    ...
                                    if (t.globals.timelineLabels.length > 0)
                                        ...
                                        for (var L = r, z = 0; z < L; z++) {
                                            ...
                                            new G(this.ctx).drawXaxisTicks(w, s);
                                        }
                                }
                                if (t.config.grid.yaxis.lines.show)
                                    for (var M = 0, T = 0, X = t.globals.gridWidth, I = 0; I < o + 1; I++) {
                                        var Y = e.drawLine(0, M, X, T, t.config.grid.borderColor, i);
                                        a.add(Y), Y.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(Y, { y1: M + 20, y2: T + 20 }, { y1: M, y2: T }), (T = M += t.globals.gridHeight / o);
                                    }
                            }
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var c = n;
                            s.globals.isXNumeric && "datetime" === s.config.xaxis.type ? (n = new D(this.ctx).xLabelFormat(s.globals.ttKeyFormatter, c, c)) : s.globals.isBarHorizontal || (n = s.globals.xLabelFormatter(c, l));
                            return (
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            e = new W(this.ctx).getActiveSeriesIndex();
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            ((i.tooltipRect = { x: 0, y: 0, ttWidth: r.getBoundingClientRect().width, ttHeight: r.getBoundingClientRect().height }), (i.e = a), !i.hasBars() || n.globals.comboCharts || i.isBarShared) ||
                                (this.tConfig.onDatasetHover.highlightDataSeries && new W(e).toggleSeriesOnHover(a, a.target.parentNode));
                ...
                s(i, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = t.context,
                                ...
                                u = {};
                            return (
                                Math.abs(l + r) > s.globals.gridWidth ? (l = s.globals.gridWidth - r) : a.clientX - n.left < 0 && (l = r),
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                if (s.globals.zoomEnabled) {
                                    var f = d.clone(s.globals.initialConfig.yaxis);
                                    ...
                                    if (
                                        ...
                                        var x = new _(a.ctx);
                                        f = x.autoScaleY(a.ctx, f, { xaxis: p });
                                    }
                                    if (r) {
                                    ...
                                    var m = { xaxis: p };
                                    s.config.chart.group || (m.yaxis = f),
                                        a.ctx._updateOptions(m, !1, a.w.config.chart.animations.dynamicAnimation.enabled),
                                    ...
                                    (v = { min: h, max: c }),
                                        ("xy" !== i && "y" !== i) ||
                                            (y = d.clone(s.config.yaxis)).forEach(function (t, e) {
                                                (y[e].min = g[e]), (y[e].max = u[e]);
                                            }),
                                        (s.globals.selection = a.selection),
                                        "function" == typeof s.config.chart.events.selection && s.config.chart.events.selection(a.ctx, { xaxis: v, yaxis: y });
                                }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i) {
                            ...
                            var r = { min: e, max: i };
                            s.config.chart.zoom.autoScaleYaxis && (n = new _(this.ctx).autoScaleY(this.ctx, n, { xaxis: r }));
                            var o = { xaxis: { min: e, max: i } };
                            s.config.chart.group || (o.yaxis = n), this.ctx._updateOptions(o, !1, !1), "function" == typeof s.config.chart.events.scrolled && s.config.chart.events.scrolled(this.ctx, { xaxis: { min: e, max: i } });
                        },
                    },
                ]),
                i
    ...
    (at = "undefined" != typeof window ? window : void 0),
        (nt = function (e, i) {
        ...
        "function" == typeof define && define.amd
            ? define(function () {
                  return nt(at, at.document);
              })
            : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module
            ? (module.exports = at.document
                  ? nt(at, at.document)
                  : function (t) {
                        return nt(t, t.document);
                    })
            : (at.SVG = nt(at, at.document)),
        function () {
            ...
            (t.prototype.init = function (t, e) {
                ...
                (t.prototype.drag = function (t) {
                    ...
                    if ("function" == typeof n) {
                        ...
                        "boolean" == typeof l && (l = { x: l, y: l }), !0 === l.x ? this.el.x(s) : !1 !== l.x && this.el.x(l.x), !0 === l.y ? this.el.y(a) : !1 !== l.y && this.el.y(l.y);
                    } else
                        "object" == typeof n &&
                            (null != n.minX && s < n.minX ? (r = (s = n.minX) - this.startPoints.box.x) : null != n.maxX && s > n.maxX - e.width && (r = (s = n.maxX - e.width) - this.startPoints.box.x),
                            null != n.minY && a < n.minY ? (o = (a = n.minY) - this.startPoints.box.y) : null != n.maxY && a > n.maxY - e.height && (o = (a = n.maxY - e.height) - this.startPoints.box.y),
                            null != n.snapToGrid && ((s -= s % n.snapToGrid), (a -= a % n.snapToGrid), (r -= r % n.snapToGrid), (o -= o % n.snapToGrid)),
                ...
                (t.prototype.transformPoint = function (t, e, i) {
                            ...
                            case "rot":
                                this.calc = function (t, e) {
                                    var i = t + this.parameters.p.x,
                                        ...
                                        n = Math.atan2(s - this.parameters.box.y - this.parameters.box.height / 2, i - this.parameters.box.x - this.parameters.box.width / 2),
                    ...
                    (t.prototype.checkAspectRatio = function (t, e) {
                        ...
                        var i = t.slice(),
                            ...
                            r = a / n;
                        return r < s ? ((i[1] = a / s - this.parameters.box.height), e && (i[1] = -i[1])) : r > s && ((i[0] = this.parameters.box.width - n * s), e && (i[0] = -i[0])), i;
                    }),
                    SVG.extend(SVG.Element, {
                        resize: function (e) {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ...
                                    t.xaxis && ((t.xaxis.min || t.xaxis.max) && this.forceXAxisUpdate(t), t.xaxis.categories && t.xaxis.categories.length && r.config.xaxis.convertedCatToNumeric && (t = v.convertCatToNumeric(t))),
                                    r.globals.collapsedSeriesIndices.length > 0 && this.clearPreviousPaths(),
                                    t.theme && (t = this.theme.updateThemeOptions(t)),
                                    this._updateOptions(t, e, i, s, a)
                                );
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                    ...
                                    n = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
                                    r = [this];
                                a && (r = this.getSyncedCharts()),
                                    this.w.globals.isExecCalled && ((r = [this]), (this.w.globals.isExecCalled = !1)),
                                    r.forEach(function (a) {
                                        var r = a.w;
                                        return (
                                            (r.globals.shouldAnimate = s),
                                            i || ((r.globals.resized = !0), (r.globals.dataChanged = !0), s && a.series.getPreviousPaths()),
                                            e &&
                                                "object" === t(e) &&
                                                ((a.config = new w(e)),
                                                (e = y.extendArrayProps(a.config, e)),
                                                (r.config = d.extend(r.config, e)),
                                                n && ((r.globals.lastXAxis = []), (r.globals.lastYAxis = []), (r.globals.initialConfig = d.extend({}, r.config)), (r.globals.initialSeries = JSON.parse(JSON.stringify(r.config.series))))),
                                            a.update(e)
                                        );
                                    });
                            },
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return s.push(t), this.resetSeries(!1), this.revertDefaultAxisMinMax(), this._updateSeries(s, e, i);
                            },
                        },
                        {
                            key: "_updateSeries",
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                i.globals.axisCharts
                                    ...
                                    : ((s = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "']")).members[0]),
                                      ("pie" === i.config.chart.type || "donut" === i.config.chart.type) && new I(this.ctx).pieClicked(t));
                                s ? new f(this.ctx).pathMouseDown(s, null) : console.warn("toggleDataPointSelection: Element not found");
                        ...
                        },
                        {
                            key: "dataURI",
                            value: function () {
                                return new rt(this.ctx).dataURI();
                            },
                        },
                        {
                            key: "paper",
