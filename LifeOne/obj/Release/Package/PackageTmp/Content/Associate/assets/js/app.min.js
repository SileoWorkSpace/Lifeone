!(function (e) {
    ...
    (t.prototype.initTooltipPlugin = function () {
        ...
        (t.prototype.initSlimScrollPlugin = function () {
            e.fn.slimScroll && e(".slimscroll").slimScroll({ height: "auto", position: "right", size: "4px", touchScrollStep: 20, color: "#9ea5ab" });
        }),
    ...
    (function (n) {
        ...
        (t.prototype._resetSidebarScroll = function () {
            n(".slimscroll-menu").slimscroll({ height: "auto", position: "right", size: "4px", color: "#9ea5ab", wheelStep: 5, touchScrollStep: 20 });
        }),
                ...
                n(".button-menu-mobile").on("click", function (t) {
                    t.preventDefault(),
                        "topnav" === e.$body.data("layout")
                            ? (n(this).toggleClass("open"), n("#topnav-menu-content").slideToggle(400))
                            : (e.$body.toggleClass("sidebar-enable"), 768 <= e.$window.width() ? e.$body.toggleClass("left-side-menu-condensed") : e.$body.removeClass("left-side-menu-condensed"), e._resetSidebarScroll());
                });
                ...
                n(".right-bar-toggle").on("click", function (t) {
                    ...
                    n(document).on("click", "body", function (t) {
                        0 < n(t.target).closest(".right-bar-toggle, .right-bar").length ||
                            ...
                            (n("body").removeClass("right-bar-enabled"), n("body").removeClass("sidebar-enable"));
                    }),
            ...
            (t.prototype.initLayout = function () {
                768 <= this.$window.width() && this.$window.width() <= 1024 ? this.$body.addClass("left-side-menu-condensed") : 1 != this.$body.data("left-keep-condensed") && this.$body.removeClass("left-side-menu-condensed"),
                    this.$body.hasClass("scrollable-layout") && n("#sidebar-menu").removeClass("slimscroll-menu");
            }),
            (t.prototype.init = function () {
                var e = this;
                this.initLayout(),
