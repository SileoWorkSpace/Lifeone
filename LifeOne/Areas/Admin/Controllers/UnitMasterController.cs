...
namespace LifeOne.Areas.Admin.Controllers
{
    ...
    {
        // GET: Admin/UnitMaster
        public ActionResult Index()
        {
            return View();
        }

        public ActionResult Unit(MAdminUnit model)
        {
            if (!PermissionManager.IsActionPermit("Unit Master", ViewOptions.FormView))
            {
        ...
        [HttpPost]
        public ActionResult UnitSave(MAdminUnit model)
        {
