    ...
    (t.prototype.save = function () {
        ...
        return "" == t
            ...
            : (r(
              ...
              this.$chatList.animate({ scrollTop: this.$chatList.prop("scrollHeight") }, 1e3),
              !0);
    }),
    ...
    (function (o) {
        ...
        (t.prototype.initCharts = function () {
            ...
            new ApexCharts(document.querySelector("#today-revenue-chart"), t).render(),
                new ApexCharts(document.querySelector("#today-product-sold-chart"), o.extend({}, t, { colors: ["#f77e53"] })).render(),
                new ApexCharts(document.querySelector("#today-new-customer-chart"), o.extend({}, t, { colors: ["#43d39e"] })).render(),
            ...
            r = {
                chart: { height: 296, type: "bar", stacked: !0, toolbar: { show: !1 } },
                ...
                xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun"], axisBorder: { show: !1 } },
                legend: { show: !1 },
                grid: { row: { colors: ["transparent", "transparent"], opacity: 0.2 }, borderColor: "#f3f4f7" },
                tooltip: {
                    y: {
                        formatter: function (t) {
                            return "$ " + t + " thousands";
